...
import { User, Plus, Award, LogOut } from "lucide-react";
import { useRouter } from "next/navigation";

export function AgentProfileMenu() {
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-[#0C0C0C] border border-[#1f1f1f] rounded-xl shadow-xl z-50 overflow-hidden">
                    <div className="p-4 border-b border-[#1f1f1f]">
                        <p className="text-sm font-medium text-white">Mon Profil Agent</p>
                        <p className="text-xs text-gray-400 mt-1">Gérez vos activités</p>
                    </div>
